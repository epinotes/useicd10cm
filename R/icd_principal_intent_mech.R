#' Add intent, mechanism, and description to injury ICD-10-CM using the principal diagnosis only.
#'
#'
...
#' icd_principal_intent_mech(icd10cm_main = principal_diag, reference = "mechanism")
#'
#'data_mech %>%
#'drop_na() %>%
...
icd_principal_intent_mech <- function(data, icd10cm_main,
